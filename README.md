...
Open the site and pick a **module** (100 questions) or **All modules** (a mixed pool of all 400
...
1. Edit the Obsidian note, following the grammar above exactly. Questions are numbered globally
   per subject (Q1–Q400) and **must stay contiguous**, with 100 per module — the build enforces
...
precache the shell and all eight data files. Check DevTools → Application → Cache Storage for a
single `study-vN` holding 21 entries.
